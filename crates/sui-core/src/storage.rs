...
impl WriteStore for RocksDbStore {
    ...
    fn update_highest_synced_checkpoint(
        ...
        // When multiple parties are downloading checkpoints (i.e. archive, stat sync, etc), they may
        // race and make this watermark go back which we don't ever want to happen
