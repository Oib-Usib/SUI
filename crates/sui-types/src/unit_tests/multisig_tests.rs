...
fn multisig_scenarios() {
    ...
    assert!(multi_sig1
        .verify_secure_generic(&msg, addr, None, &VerifyParams::default())
        .is_ok());
    ...
    assert!(multi_sig_6
        .verify_secure_generic(&msg, addr_2, None, &VerifyParams::default())
        .is_ok());
...
fn test_max_sig() {
    ...
    assert!(multisig
        .verify_secure_generic(&msg, address, None, &VerifyParams::default())
        .is_err());
